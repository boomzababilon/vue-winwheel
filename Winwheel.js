...
export class Winwheel {
	constructor(options, drawWheel) {
		var defaultOptions = {
			...
			textFillStyle: 'silver', // This is basically the text colour.
			textStrokeStyle: 'black', // Basically the line colour for segment text, only looks good for large text so off by default.
